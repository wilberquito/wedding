...
var app = (function () {
    ...
    const file = "src/CountDown.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span0, "class", "countdown svelte-1yumlik");
    			add_location(span0, file, 45, 8, 1291);
    			attr_dev(span1, "class", "label svelte-1yumlik");
    			add_location(span1, file, 48, 8, 1377);
    			attr_dev(div0, "class", "countdown__item svelte-1yumlik");
    			add_location(div0, file, 44, 4, 1253);
    			attr_dev(span2, "class", "countdown svelte-1yumlik");
    			add_location(span2, file, 51, 8, 1462);
    			attr_dev(span3, "class", "label svelte-1yumlik");
    			add_location(span3, file, 54, 8, 1549);
    			attr_dev(div1, "class", "countdown__item svelte-1yumlik");
    			add_location(div1, file, 50, 4, 1424);
    			attr_dev(span4, "class", "countdown svelte-1yumlik");
    			add_location(span4, file, 57, 8, 1635);
    			attr_dev(span5, "class", "label svelte-1yumlik");
    			add_location(span5, file, 60, 8, 1723);
    			attr_dev(div2, "class", "countdown__item svelte-1yumlik");
    			add_location(div2, file, 56, 4, 1597);
    			attr_dev(span6, "class", "countdown svelte-1yumlik");
    			add_location(span6, file, 63, 8, 1811);
    			attr_dev(span7, "class", "label svelte-1yumlik");
    			add_location(span7, file, 66, 8, 1900);
    			attr_dev(div3, "class", "countdown__item svelte-1yumlik");
    			add_location(div3, file, 62, 4, 1773);
    			attr_dev(div4, "class", "countdown__container svelte-1yumlik");
    			add_location(div4, file, 43, 0, 1214);
    		},
